(function(){
	...
	ComponentExtUtil.buildStore = function(){
    	...
    	this.store = Ext.create('Ext.data.Store', {
			...
			proxy : {
				type: 'ajax',
		        url: 'xcc_customquery/queryComponentRecords.action',
		    	reader : {
					type : 'json',
					root : 'items',
	...
	ComponentExtUtil.buildTopBar = function(){
    	...
    	if(this.isCanExport){
    		var exportButton = Ext.create('XIRJS.widget.button.ExportButton', {
    			...
    			exportUrl: 'xcc_customquery/export4Xls.action'
    		});
		...
		if(this.isCanSearch){
			var searchButton = Ext.create('Ext.button.Button', {
    			text : '搜索',
    			icon :'xcc/images/icon/search.gif',
    			scope : this,
 ...
 * 查询窗体实例
 */
Ext.define('XIRJS.grid.base.BaseGrid', {
